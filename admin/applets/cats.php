                        ...
                        <div id="upr_publish">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="checklist">
                                <tr>
                                    ...
                                    <td>
                                        <label for="published">
                                            <strong><?php echo $_LANG['AD_PUBLIC_SECTION'];?></strong>
                                        </label>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style=" <?php if ($do=='edit'){  ?>display:none;<?php } ?>" class="url_cat">
                                <div style="margin-top:15px">
                                    ...
                                    <div class="hinttext"><?php echo $_LANG['AD_FROM_TITLE'];?></div>
                                </div>
                                <div>
                            ...
                            <table width="100%" style="margin-top:20px">
                                <tr>
                                    ...
                                    <td>
                                        <input class="uispin" name="maxcols" type="text" id="maxcols" style="width:50px" value="<?php echo cmsCore::getArrVal($mod, 'maxcols', 1); ?>" />
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <div class="uibtnset">
                                            <input type="radio" id="showdesc_1" name="showdesc" <?php if (cmsCore::getArrVal($mod, 'showdesc') || $do == 'add') { echo 'checked="checked"'; } ?> value="1" /><label for="showdesc_1"><?php echo $_LANG['YES'];?></label>
                                            <input type="radio" id="showdesc_0" name="showdesc" <?php if (!cmsCore::getArrVal($mod, 'showdesc') && $do != 'add') { echo 'checked="checked"'; } ?> value="0" /><label for="showdesc_0"><?php echo $_LANG['NO'];?></label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="uibtnset">
                                            <input type="radio" id="showdate_1" name="showdate" <?php if (cmsCore::getArrVal($mod, 'showdate') || $do == 'add') { echo 'checked="checked"'; } ?> value="1" /><label for="showdate_1"><?php echo $_LANG['YES'];?></label>
                                            <input type="radio" id="showdate_0" name="showdate" <?php if (!cmsCore::getArrVal($mod, 'showdate') && $do != 'add') { echo 'checked="checked"'; } ?> value="0" /><label for="showdate_0"><?php echo $_LANG['NO'];?></label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="uibtnset">
                                            <input type="radio" id="showcomm_1" name="showcomm" <?php if (cmsCore::getArrVal($mod, 'showcomm') || $do == 'add') { echo 'checked="checked"'; } ?> value="1" /><label for="showcomm_1"><?php echo $_LANG['YES'];?></label>
                                            <input type="radio" id="showcomm_0" name="showcomm" <?php if (!cmsCore::getArrVal($mod, 'showcomm') && $do != 'add') { echo 'checked="checked"'; } ?> value="0" /><label for="showcomm_0"><?php echo $_LANG['NO'];?></label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="uibtnset">
                                            <input type="radio" id="showtags_1" name="showtags" <?php if (cmsCore::getArrVal($mod, 'showtags') || $do == 'add') { echo 'checked="checked"'; } ?> value="1" /><label for="showtags_1"><?php echo $_LANG['YES'];?></label>
                                            <input type="radio" id="showtags_0" name="showtags" <?php if (!cmsCore::getArrVal($mod, 'showtags') && $do != 'add') { echo 'checked="checked"'; } ?> value="0" /><label for="showtags_0"><?php echo $_LANG['NO'];?></label>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="uibtnset">
                                            <input type="radio" id="showrss_1" name="showrss" <?php if (cmsCore::getArrVal($mod, 'showrss') || $do == 'add') { echo 'checked="checked"'; } ?> value="1" /><label for="showrss_1"><?php echo $_LANG['YES'];?></label>
                                            <input type="radio" id="showrss_0" name="showrss" <?php if (!cmsCore::getArrVal($mod, 'showrss') && $do != 'add') { echo 'checked="checked"'; } ?> value="0" /><label for="showrss_0"><?php echo $_LANG['NO'];?></label>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="margin-top:10px">
                                <table>
                                    <tr valign="top">
                                        ...
                                        <td width="110">
                                            <div class="uibtnset">
                                                <input type="radio" id="is_public_1" name="is_public" <?php if (cmsCore::getArrVal($mod, 'is_public')) { echo 'checked="checked"'; } ?> value="1" /><label for="is_public_1"><?php echo $_LANG['YES'];?></label>
                                                <input type="radio" id="is_public_0" name="is_public" <?php if (!cmsCore::getArrVal($mod, 'is_public')) { echo 'checked="checked"'; } ?> value="0" /><label for="is_public_0"><?php echo $_LANG['NO'];?></label>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
