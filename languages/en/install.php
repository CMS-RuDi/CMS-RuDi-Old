...
$_LANG['INS_DB_HOST_EMPTY']              = 'You must specify a DB server!';
$_LANG['INS_DB_BASE_EMPTY']              = 'You must specify a DB name!';
$_LANG['INS_DB_USER_EMPTY']              = 'You must specify a DB user!';
$_LANG['INS_DB_PREFIX_EMPTY']            = 'You must specify a DB prefix!';
$_LANG['INS_ADMIN_LOGIN_EMPTY']          = 'Create a username of administrator, at least 3 characters!';
$_LANG['INS_ADMIN_PASS_6']               = 'at least 6 characters!';
$_LANG['INS_ADMIN_PASS_EMPTY']           = 'Create a password of administrator, '.$_LANG['INS_ADMIN_PASS_6'];
$_LANG['INS_HEADER']                     = 'Installation of InstantCMS';
...
$_LANG['INS_CHECK_FOLDER']               = 'Testing the folders rights';
...
$_LANG['INS_PHP_VERSION']                = 'Version of PHP interpreter';
$_LANG['INS_INSTALL_VERSION']            = 'The installed version';
$_LANG['INS_NEED_EXTENTION']             = 'The required PHP extension';
$_LANG['INS_PHPNET_HINT']                = 'See the description on the PHP site';
...
$_LANG['INS_PERMISSION']                 = 'The current access permissions';
$_LANG['INS_PERMISSION_OK']              = 'writable';
$_LANG['INS_PERMISSION_NO']              = 'non writable';
$_LANG['INS_FORM_INSERT']                = 'Fill out the form and click "Install" to complete the process.';
