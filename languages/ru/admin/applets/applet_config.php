...
$_LANG['AD_COLLECT_CSS']               = 'Собирать все CSS файлы в один';
$_LANG['AD_COLLECT_CSS_INFO']          = 'Внимание. Перед включением этой опции убедитесь что ссылки на картинки в css файлах ведут от корня сайта, и не имеют вид "../images/xxx.jpg"';
$_LANG['AD_COLLECT_JS']                = 'Собирать все JS файлы в один';
$_LANG['AD_COLLECT_JS_INFO']           = 'Внимание. Перед включением этой опции убедитесь что ссылки на картинки и другие файлы в js файлах ведут от корня сайта, и не имеют вид "../images/xxx.jpg"';
