...
$_LANG['AD_CACHE']                     = 'Кэширование';
$_LANG['AD_CACHE_INFO']                = 'Включение отключение этой опции не влияет на объединение js и css файлов. Но влияет на все остальное, в том числе кэширование модулей.';
$_LANG['AD_TIME']                      = 'Время';
...
$_LANG['AD_SITE_ONLY_AUTHORIZED']      = 'Сайт доступен только авторизованным';
$_LANG['AD_SITE_ONLY_AUTHORIZED_INFO'] = 'При включении этой опции ни один раздел сайта не доступен для гостей, кроме страницы авторизации и регистрации.';
...
$_LANG['AD_IFRAME_APP_ID']             = 'ID Приложения';
$_LANG['AD_IFRAME_APP_PUBLIC_KEY']     = 'Публичный ключ';
$_LANG['AD_IFRAME_APP_PRIVATE_KEY']    = 'Приватный ключ';

$_LANG['AD_COM_WITHOUT_NAME_IN_URL']   = 'Компонент по умолчанию';
$_LANG['AD_COLLECT_CSS']               = 'Объединить CSS файлы в один';
$_LANG['AD_COLLECT_CSS_INFO']          = 'Список CSS файлов каждый с новой строки, ссылки от корня без переднего слеша "/".<br/> Внимание. Убедитесь что ссылки на картинки в файлах ведут от корня сайта, и не имеют вид "../images/xxx.jpg"';
$_LANG['AD_COLLECT_JS']                = 'Объединить JS файлы в один';
$_LANG['AD_COLLECT_JS_INFO']           = 'Список JS файлов каждый с новой строки, ссылки от корня без переднего слеша "/".<br/> Внимание. Убедитесь что ссылки на картинки в файлах ведут от корня сайта, и не имеют вид "../images/xxx.jpg"';
$_LANG['AD_PAGEBAR_MAX_LINKS']         = 'Максимальное количество ссылок в PageBar';
$_LANG['AD_CACHE_TYPE']                = 'Тип кэша';
$_LANG['AD_CACHE_TYPE_INFO']           = 'В данный момент поддерживается файловый кэш и Memcached. Если в списке не отображается Memcached то он у вас на сервере не установлен или установлен но не установлен модуль для php.';
$_LANG['AD_MEMCACHED_HOST']            = 'Хост Memcached';
$_LANG['AD_MEMCACHED_HOST_INFO']       = 'В этом параметре можно также указать другие транспорты, как unix:///path/to/memcached.sock т.е. использовать UNIX сокеты, в этом случае порт должен быть установлен в 0';
$_LANG['AD_MEMCACHED_PORT']            = 'Порт Memcached';
$_LANG['AD_MEMCACHED_PORT_INFO']       = 'Порт, на котором Memcached слушает соединения. Установите этот параметр в 0, если предполагается использование сокетов';
$_LANG['AD_SCHEME_TYPE']               = 'Протокол';
