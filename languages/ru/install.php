...
$_LANG['INS_HEADER']                     = 'Установка CMS RuDi';
...
$_LANG['INS_WELCOME_NOTES']              = '<p>Cкрипт установки проверит сервер на соответствие техническим требованиям и совершит все необходимые действия для начала работы с CMS RuDi.</p><p>Устанавливать CMS RuDi можно только в корневую директорию сайта.</p><p>Перед началом установки создайте новую базу данных MySQL на вашем хостинге. Сравнение (COLLATION) должно быть любое из utf8_* согласно ваших потребностей. В большинстве случаев это utf8_general_ci.</p><p>Как установить систему на локальный компьютер с ОС Windows&trade; для тестирования, читайте в <a href="http://www.instantcms.ru/wiki/doku.php/локальная_установка_денвер" target="_blank">инструкции</a> на официальном сайте.</p><p>CMS RuDi распространяется по лицензии GNU/GPL версии 2. Вы должны согласиться с условиями этой лицензии для установки системы.</p>';
...
$_LANG['CFG_KEYWORDS']                   = 'CMS RuDi, система управления сайтом, бесплатная CMS, движок сайта, CMS, движок социальной сети';
$_LANG['CFG_METADESC']                   = 'CMS RuDi - бесплатная система управления сайтом с социальными функциями';