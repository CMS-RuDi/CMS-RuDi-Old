...
$_LANG['INSERT_CAPTCHA_ERROR']   = '<p><div>Капча не найдена либо не включена.</div><div>Если капча установлена, включите ее в админке (меню <em>Дополнения</em> &rarr; <em>Плагины</em>).</div></p>';
...
$_LANG['TEMPLATE_SAVE_PASS']      = 'Запомнить меня';
$_LANG['TEMPLATE_FORGOT_PASS']    = 'Забыли пароль?';
