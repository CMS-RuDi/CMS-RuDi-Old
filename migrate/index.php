...
/******************************************************************************/
    ...
    $migrateDB = new migrateDB(array(
        ...
        'queries' => array(
            ...
            array( 'sql' => "CREATE TABLE cms_cron_logs (id int(11) DEFAULT NULL, cron_id int(11) DEFAULT NULL, msg text DEFAULT NULL, run_date datetime DEFAULT NULL) ENGINE = INNODB CHARACTER SET utf8 COLLATE utf8_general_ci;", 'msg' => 'Таблица cms_cron_logs создана' )
        ),
