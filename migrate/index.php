...
/******************************************************************************/
    ...
    $migrateDB = new migrateDB(array(
        ...
        'queries' => array(
            ...
            array( 'sql' => "CREATE TABLE cms_cron_logs ( id int(11) NOT NULL AUTO_INCREMENT, cron_id int(11) DEFAULT NULL, msg longtext DEFAULT NULL, run_date datetime DEFAULT NULL, PRIMARY KEY (id) ) ENGINE = INNODB AUTO_INCREMENT = 1 CHARACTER SET utf8 COLLATE utf8_general_ci", 'msg' => 'Таблица cms_cron_logs создана' )
        ),
