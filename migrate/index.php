...
/******************************************************************************/
    ...
    $migrateDB = new migrateDB(array(
        ...
        'inserts' => array(
            ...
            array( 'table' => 'cms_components', 'where' => "link='sitemap'", 'insert_array' => array('title' => 'Карта сайта', 'link' => 'sitemap', 'interval' => 0, 'author' => 'DS Soft', 'published' => 1, 'version' => '2.2.0', 'system' => 1, 'config' => '---\nperpage: 100\nhtml_map_enable: 1\nblogs:\n  published: 1\n  mode: all\n  regen_time: 24\nfaq:\n  published: 1\n  mode: all\n  regen_time: 24\nboard:\n  published: 1\n  mode: all\n  regen_time: 24\ncontent:\n  published: 1\n  mode: all\n  regen_time: 24\nclubs:\n  published: 1\n  mode: all\n  regen_time: 24\nusers:\n  published: 1\n  mode: all\n  regen_time: 24\ncatalog:\n  published: 1\n  mode: all\n  regen_time: 24\nforum:\n  published: 1\n  mode: all\n  regen_time: 24\nphotos:\n  published: 1\n  mode: all\n  regen_time: 24\n'), 'msg' => 'Установлен компонент <b>Карта сайта</b> sitemap.' ),
        ...
        'queries' => array(
            array( 'sql' => "UPDATE `cms_components` SET `title`='Карта сайта', `interval`='0', `author`='DS Soft', `version`='2.2.0', `system`='1' WHERE `link`='sitemap' LIMIT 1" ),
