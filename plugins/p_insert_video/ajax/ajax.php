...
if ($do == 'insert'){
    ...
    if (!empty($code)){
        ...
        cmsCore::c('jevix')->cfgAllowTagParams('embed', array('src' => array('#domain' => $domains), 'type' => '#text', 'allowscriptaccess' => '#text', 'allowFullScreen' => '#text', 'width' => '#int', 'height' => '#int', 'flashvars' => '#text', 'wmode'=> '#text'));
