        ...
        <?php foreach($actions as $action) { ?>
            <div class="action_entry act_<?php echo $action['name']; ?>">
                <div class="action_date
                    ...
                    <a href="/actions/delete/<?php echo $action['id']; ?>" class="action_delete uittip" title="<?php echo $_LANG['DELETE']; ?>" onclick="if(!confirm('<?php echo $_LANG['AD_DELETE_ACTION']; ?>')){ return false; }"></a>
                </div>
