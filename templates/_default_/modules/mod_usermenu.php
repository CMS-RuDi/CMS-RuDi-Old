<div class="mod_user_menu">
    <?php if ($id) { ?>
        ...
        <?php if ($iframe_provider == 'vk') { ?>
            <span class="showInviteBox">
                <a href="#" title="<?php echo $_LANG['INVITE_FRIENDS_TO_APP']; ?>" onclick="VK.callMethod('showInviteBox');"><?php echo $_LANG['INVITE_FRIENDS']; ?></a>
            </span>
        <?php } ?>
